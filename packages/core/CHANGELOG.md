...
- 🐛 **移除 `@ast-core/escape` 运行时依赖，并内联等价的 JS 字符串转义逻辑以保持字符串字面量改写行为不变。** [`a779638`](https://github.com/sonofmagic/tailwindcss-mangle/commit/a779638312d27f6e287f9834ed32cee08ff392e0) by @sonofmagic
- 📦 **Dependencies** [`bb9ee58`](https://github.com/sonofmagic/tailwindcss-mangle/commit/bb9ee58006f744a349cf46abed84d0b0506a01f3)
  → `@tailwindcss-mangle/shared@5.0.0`, `@tailwindcss-mangle/config@8.0.0`, `@tailwindcss-mangle/engine@0.1.2`
...
- 📦 **Dependencies** [`9f510d4`](https://github.com/sonofmagic/tailwindcss-mangle/commit/9f510d4614cd1a40d328b8b56adcbfe6700757f6)
  → `@tailwindcss-mangle/config@7.0.1`, `@tailwindcss-mangle/shared@4.1.5`
...
- 📦 **Dependencies** [`a64c0da`](https://github.com/sonofmagic/tailwindcss-mangle/commit/a64c0dae16d0b1d18f6bc88338abe2103b204c4d)
  → `@tailwindcss-mangle/shared@4.1.2`, `@tailwindcss-mangle/config@6.1.2`

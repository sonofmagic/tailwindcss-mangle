...
- 📦 **Dependencies** [`8034bc2`](https://github.com/sonofmagic/tailwindcss-mangle/commit/8034bc2015823944c58f0649f127df2ac1ff3633)
...
- 📦 **Dependencies** [`bb9ee58`](https://github.com/sonofmagic/tailwindcss-mangle/commit/bb9ee58006f744a349cf46abed84d0b0506a01f3)
  → `@tailwindcss-mangle/config@8.0.0`, `@tailwindcss-mangle/engine@0.1.2`
...
- 🐛 **支持在 source 扫描和 v4 生成器中提取 UnoCSS 风格裸任意值 class，并导出对应 resolver 与 selector 工具，便于上层 Tailwind v3 / v4 适配复用同一套候选解析。** [`71adc45`](https://github.com/sonofmagic/tailwindcss-mangle/commit/71adc459abae5a2d5b1f6683ae8289ea872dacb0) by @sonofmagic
...
- 🐛 **修复发布包 `dist` 入口没有导出 `splitCandidateTokens`、`isValidCandidateToken` 和 `validateCandidateTokenRE` 的问题，并收敛源码入口与发布入口的公共 API 导出。** [`3dd8f35`](https://github.com/sonofmagic/tailwindcss-mangle/commit/3dd8f35ac6c464256e5fdcc9b3d01c3a29864b28) by @sonofmagic

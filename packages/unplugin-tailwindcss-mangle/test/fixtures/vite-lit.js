;(function () {
  ...
  new MutationObserver((e) => {
    for (const r of e) if (r.type === 'childList') for (const s of r.addedNodes) s.tagName === 'LINK' && s.rel === 'modulepreload' && o(s)
...
const l = '/assets/typescript-f6ead1af.svg'
function i(n) {
  let t = 0
  const a = (o) => {
    ;(t = o), (n.innerHTML = `count is ${t}`)
  }
  n.addEventListener('click', () => a(t + 1)), a(0)
}
...
<div class="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
  ...
  <div
    ...
    <a class="pointer-events-none flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0"
      ...
      By
      <img src="${l}" alt="Vercel Logo" class="dark:invert" priority />
    </a>
  </div>
</div>
